...
#### About
Aster is a decentralized crowd-funding platform which allows anyone to create campaigns and to donate to others using
    Ethereum. It's hosted on the Arweave permaweb, and is entirely decentralized in its operation.

To use Aster if you'd like to fund an endeavor, simply log in using MetaMask and your Arweave wallet. From there, you
    ...
    from the Aster smart contract to your own account.

To use Aster as a funder, simply browse around for a project that you'd like to fund. Once you've found one, you can
...
There are of course certain limitations with Aster, primarily the fact that **you should in no circumstances
