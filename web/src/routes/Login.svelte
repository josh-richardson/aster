<script>
    ...
    const onLoginClick = async e => {
        try {
            ...
            var coin = new web3.eth.Contract(abi, "0x9479158D0Aa0554d661376ac97EeeDEDE847C269", {defaultAccount: owner});
            let reply = await coin.methods.returnAllProjects().call({from: owner});
            console.log(reply);
